...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/CollatzPlot1-1} 
\end{knitrout}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/CollatzPlot2-1} 
\end{knitrout}
%Code to insert a figure [H]ere
\begin{figure}[H]
\begin{center}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/CollatzPlot3-1} 
\end{knitrout}
%Code to insert a figure [H]ere
\begin{figure}[H]
\begin{center}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/PlanetPlot1-1} 
\end{knitrout}
%Code to insert a figure [H]ere
\begin{figure}[H]
\begin{center}
